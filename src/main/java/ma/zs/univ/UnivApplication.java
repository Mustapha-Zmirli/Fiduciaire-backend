...
public class UnivApplication {
    ...
    private static void addPermissionForAdmin(List<ModelPermission> modelPermissions) {
        ...
        modelPermissions.add(new ModelPermission("Comptable"));
        modelPermissions.add(new ModelPermission("PaiementComptableValidateur"));
        modelPermissions.add(new ModelPermission("CategoriePieceJoint"));
        modelPermissions.add(new ModelPermission("PaiementComptableTraitant"));
        modelPermissions.add(new ModelPermission("Societe"));
        modelPermissions.add(new ModelPermission("PaiementDemande"));
        modelPermissions.add(new ModelPermission("DemandePieceJoint"));
        modelPermissions.add(new ModelPermission("EtatDemande"));
        modelPermissions.add(new ModelPermission("CategorieComptable"));
