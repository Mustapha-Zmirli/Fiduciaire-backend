...
public class EtatDemandeRestAdmin  extends AbstractController<EtatDemande, EtatDemandeDto, EtatDemandeCriteria, EtatDemandeAdminService, EtatDemandeConverter> {



    @Operation(summary = "upload one etatDemande")
    @RequestMapping(value = "upload", method = RequestMethod.POST, consumes = "multipart/form-data")
    public ResponseEntity<FileTempDto> uploadFileAndGetChecksum(@RequestBody MultipartFile file) throws Exception {
        return super.uploadFileAndGetChecksum(file);
    }
    @Operation(summary = "upload multiple etatDemandes")
    ...
    public ResponseEntity<EtatDemandeDto> findByLibelle(@PathVariable String libelle) {
        return super.findByReferenceEntity(new EtatDemande(libelle));
    }
    ...
    @Operation(summary = "Delete multiple etatDemandes by ids")
    ...
    @Operation(summary = "Exports etatDemandes by criteria")
    @PostMapping("export")
