function fn() {
    ...
    const urlDev = 'jdbc:mysql://localhost:3306/fudiciaire';
    ...
    config.comptableUrl = config.adminUri + 'comptable/';
    config.paiementComptableValidateurUrl = config.adminUri + 'paiementComptableValidateur/';
    config.categoriePieceJointUrl = config.adminUri + 'categoriePieceJoint/';
    config.paiementComptableTraitantUrl = config.adminUri + 'paiementComptableTraitant/';
    config.societeUrl = config.adminUri + 'societe/';
    config.paiementDemandeUrl = config.adminUri + 'paiementDemande/';
    config.demandePieceJointUrl = config.adminUri + 'demandePieceJoint/';
    config.etatDemandeUrl = config.adminUri + 'etatDemande/';
    config.categorieComptableUrl = config.adminUri + 'categorieComptable/';
