...
import ma.zs.univ.ws.facade.admin.demande.TypeDemandeRestAdmin;
...
public class TypeDemandeRestAdminTest {
    ...
    public void itShouldSaveTypeDemandeTest() throws Exception {
        ...
        assertEquals(savedDto.getHonnoraireComptableTraitant(), responseBody.getHonnoraireComptableTraitant());
        assertEquals(savedDto.getHonnoraireComptableValidateur(), responseBody.getHonnoraireComptableValidateur());
    }
